...
# ==================================================
# Link Hosting Kalian
Zuz99="raw.githubusercontent.com/Zuz99/Mantap/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Zuz99/Mantap/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Zuz99/Mantap/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Zuz99/Mantap/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
